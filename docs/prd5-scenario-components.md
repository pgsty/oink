...
状态：**0.4 阅读与发布、0.5 Landing 已实现并冻结；0.6 Book 待后续实现**
—— 开放问题已于 2026-08-13 裁决（见 §8 逐条决议）；已实现契约见
`prd5-reading-release-contract.md` 与 `prd5-landing-contract.md`。源码完成
不等于标签发布、消费站 pin 或线上部署。
