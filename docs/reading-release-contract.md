...
This document freezes the 0.4 reading and release track. Its machine-readable companion
...
`params.ui.pager_types`; only those three type names are valid. A page or
...
`params.ui.docs_sidebar_root: home`; the sidebar and pager then traverse the same home
