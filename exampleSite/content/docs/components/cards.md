...
{{< /card >}}
{{< card title="Configure" link="/docs/content-primitives/" icon="fa-solid fa-sliders" >}}
...
{{< /card >}}
{{< card title="With image" link="/docs/gallery/" image="/media/content-primitives-global.png" image_alt="Green and violet preview" >}}
