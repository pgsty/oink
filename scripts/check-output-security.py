...
Usage:
  scripts/check-output-security.py --public exampleSite/public --base-url https://example.org/
  scripts/check-output-security.py --public DIR --base-url URL --third-party   # site embeds third-party content
